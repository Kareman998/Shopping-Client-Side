...
import SimilarProduct from "../../components/ProductPreview/SimilarProduct";
import "./ProductPage.css";
import { LinkContainer } from "react-router-bootstrap";
import { useAddToCartMutation } from "../../services/appApi";
import ToastMessage from "../../components/Toastmassege/ToastMessage";
                ...
                <Col lg={6} className="pt-4">
                    ...
                    {user && !user.isAdmin && (
                        <ButtonGroup style={{ width: "90%" }}>
                            ...
                            <Button size="lg bg-warning" onClick={() => addToCart({ userId: user._id, productId: id, price: product.price, image: product.pictures[0].url })}>
                                Add to cart
                            </Button>
                        </ButtonGroup>
                    )}
                    ...
                    {isSuccess && <ToastMessage bg="success" title="Added to cart" body={`${product.name} is in your cart`} />}
                </Col>
            </Row>
            <div className="my-4">
                <h2> Products Like it</h2>
